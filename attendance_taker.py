        ...
        if existing_entry:
            ...
            try:
                message = client.messages.create(
                    body=f"Hello {name}, you have been marked as present on {current_date} at {current_time}.",
                    from_=keys.twilio_number,
                    to=keys.my_phone_number  # Ensure 'keys.my_phone_number' is set to the intended recipient's number
                )
